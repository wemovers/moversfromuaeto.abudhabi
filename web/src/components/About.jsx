              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="count-area-content">
                    <div className="count-digit">100K</div>
                    <div className="count-title">Client Satisfaction</div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="count-area-content">
                    <div className="count-digit">1K</div>
                    <div className="count-title">Great Reviews</div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="count-area-content">
                    <div className="count-digit">5K</div>
                    <div className="count-title">Reliable Service</div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="count-area-content">
                    <div className="count-digit">20K</div>
                    <div className="count-title">Global Contact</div>
                  </div>
                </div>
              </div>
            </div>
